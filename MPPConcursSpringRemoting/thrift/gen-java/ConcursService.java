...
public class ConcursService {
  ...
  public interface Iface {
    ...
    public void login(User user, ClientServer client) throws ConcursException, org.apache.thrift.TException;

    public void logout(User user, ClientServer client) throws ConcursException, org.apache.thrift.TException;

    public java.util.List<Proba> getProbeAndNrParticipanti() throws ConcursException, org.apache.thrift.TException;

    public java.util.List<Participant> getParticipantiByProba(int idProba) throws ConcursException, org.apache.thrift.TException;

    public void inscriereParticipant(Participant participant, java.lang.String tipProba1, java.lang.String tipProba2) throws ConcursException, org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void login(User user, ClientServer client, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void logout(User user, ClientServer client, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void getProbeAndNrParticipanti(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Proba>> resultHandler) throws org.apache.thrift.TException;

    public void getParticipantiByProba(int idProba, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Participant>> resultHandler) throws org.apache.thrift.TException;

    public void inscriereParticipant(Participant participant, java.lang.String tipProba1, java.lang.String tipProba2, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_login(User user, ClientServer client) throws org.apache.thrift.TException
    {
    ...
    public void send_logout(User user, ClientServer client) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<Proba> recv_getProbeAndNrParticipanti() throws ConcursException, org.apache.thrift.TException
    {
    ...
    public java.util.List<Participant> recv_getParticipantiByProba() throws ConcursException, org.apache.thrift.TException
    {
    ...
    public void send_inscriereParticipant(Participant participant, java.lang.String tipProba1, java.lang.String tipProba2) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class login_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public login_call(User user, ClientServer client, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class logout_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private User user;
      private ClientServer client;
      public logout_call(User user, ClientServer client, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.user = user;
        this.client = client;
      }
    ...
    public static class getProbeAndNrParticipanti_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Proba>> {
      public getProbeAndNrParticipanti_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Proba>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
      ...
      public java.util.List<Proba> getResult() throws ConcursException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class getParticipantiByProba_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Participant>> {
      private int idProba;
      public getParticipantiByProba_call(int idProba, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Participant>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public java.util.List<Participant> getResult() throws ConcursException, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class inscriereParticipant_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public inscriereParticipant_call(Participant participant, java.lang.String tipProba1, java.lang.String tipProba2, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getProbeAndNrParticipanti<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getProbeAndNrParticipanti_args, java.util.List<Proba>> {
      public getProbeAndNrParticipanti() {
        super("getProbeAndNrParticipanti");
      }
      ...
      public void start(I iface, getProbeAndNrParticipanti_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Proba>> resultHandler) throws org.apache.thrift.TException {
        iface.getProbeAndNrParticipanti(resultHandler);
      }
    }

    public static class getParticipantiByProba<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getParticipantiByProba_args, java.util.List<Participant>> {
      public getParticipantiByProba() {
        super("getParticipantiByProba");
      }
      ...
      public void start(I iface, getParticipantiByProba_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Participant>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class login_args implements org.apache.thrift.TBase<login_args, login_args._Fields>, java.io.Serializable, Cloneable, Comparable<login_args>   {
    ...
    public @org.apache.thrift.annotation.Nullable ClientServer client; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.CLIENT, new org.apache.thrift.meta_data.FieldMetaData("client", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ClientServer.class)));
    ...
    public login_args(login_args other) {
      ...
      if (other.isSetClient()) {
        this.client = new ClientServer(other.client);
      }
    }
    ...
    public login_args setClient(@org.apache.thrift.annotation.Nullable ClientServer client) {
      this.client = client;
      return this;
    }
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, login_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 2: // CLIENT
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.client = new ClientServer();
  ...
  public static class logout_args implements org.apache.thrift.TBase<logout_args, logout_args._Fields>, java.io.Serializable, Cloneable, Comparable<logout_args>   {
    ...
    public logout_args setClient(@org.apache.thrift.annotation.Nullable ClientServer client) {
      this.client = client;
      return this;
    }
...
;
  ...
  public static class getProbeAndNrParticipanti_result implements org.apache.thrift.TBase<getProbeAndNrParticipanti_result, getProbeAndNrParticipanti_result._Fields>, java.io.Serializable, Cloneable, Comparable<getProbeAndNrParticipanti_result>   {
    ...
    public getProbeAndNrParticipanti_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<Proba> success) {
      this.success = success;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Proba>(_list0.size);
                  @org.apache.thrift.annotation.Nullable Proba _elem1;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getProbeAndNrParticipanti_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Proba _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Proba _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Proba>(_list5.size);
            @org.apache.thrift.annotation.Nullable Proba _elem6;
  ...
  public static class getParticipantiByProba_result implements org.apache.thrift.TBase<getParticipantiByProba_result, getParticipantiByProba_result._Fields>, java.io.Serializable, Cloneable, Comparable<getParticipantiByProba_result>   {
    ...
    public getParticipantiByProba_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<Participant> success) {
      this.success = success;
      return this;
    }
    ...
    private static class getParticipantiByProba_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<getParticipantiByProba_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Participant>(_list8.size);
                  @org.apache.thrift.annotation.Nullable Participant _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = new Participant();
                    _elem9.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getParticipantiByProba_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Participant _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getParticipantiByProba_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getParticipantiByProba_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getParticipantiByProba_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Participant _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Participant>(_list13.size);
            @org.apache.thrift.annotation.Nullable Participant _elem14;
  ...
  public static class inscriereParticipant_args implements org.apache.thrift.TBase<inscriereParticipant_args, inscriereParticipant_args._Fields>, java.io.Serializable, Cloneable, Comparable<inscriereParticipant_args>   {
    ...
    public inscriereParticipant_args setParticipant(@org.apache.thrift.annotation.Nullable Participant participant) {
      this.participant = participant;
      return this;
    }
