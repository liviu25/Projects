...
namespace com.service
{
  public partial class ConcursService {
    public interface ISync {
      void login(model.UserDTO user, model.ClientServerDTO client);
      void logout(model.UserDTO user, model.ClientServerDTO client);
      List<model.ProbaDTO> getProbeAndNrParticipanti();
      List<model.ParticipantDTO> getParticipantiByProba(int idProba);
      void inscriereParticipant(model.ParticipantDTO participant, string tipProba1, string tipProba2);
    }

    public interface Iface : ISync {
      #if SILVERLIGHT
      IAsyncResult Begin_login(AsyncCallback callback, object state, model.UserDTO user, model.ClientServerDTO client);
      void End_login(IAsyncResult asyncResult);
      #endif
      #if SILVERLIGHT
      IAsyncResult Begin_logout(AsyncCallback callback, object state, model.UserDTO user, model.ClientServerDTO client);
      void End_logout(IAsyncResult asyncResult);
      #endif
      #if SILVERLIGHT
      IAsyncResult Begin_getProbeAndNrParticipanti(AsyncCallback callback, object state);
      List<model.ProbaDTO> End_getProbeAndNrParticipanti(IAsyncResult asyncResult);
      #endif
      #if SILVERLIGHT
      IAsyncResult Begin_getParticipantiByProba(AsyncCallback callback, object state, int idProba);
      List<model.ParticipantDTO> End_getParticipantiByProba(IAsyncResult asyncResult);
      #endif
      #if SILVERLIGHT
      IAsyncResult Begin_inscriereParticipant(AsyncCallback callback, object state, model.ParticipantDTO participant, string tipProba1, string tipProba2);
    ...
    public class Client : IDisposable, Iface {
      ...
      public IAsyncResult Begin_login(AsyncCallback callback, object state, model.UserDTO user, model.ClientServerDTO client)
      {
      ...
      public void login(model.UserDTO user, model.ClientServerDTO client)
      {
        #if SILVERLIGHT
      ...
      #if SILVERLIGHT
      public IAsyncResult send_login(AsyncCallback callback, object state, model.UserDTO user, model.ClientServerDTO client)
      {
      ...
      public void send_login(model.UserDTO user, model.ClientServerDTO client)
      {
        oprot_.WriteMessageBegin(new TMessage("login", TMessageType.Call, seqid_));
        login_args args = new login_args();
        args.User = user;
      ...
      public IAsyncResult Begin_logout(AsyncCallback callback, object state, model.UserDTO user, model.ClientServerDTO client)
      {
      ...
      public void logout(model.UserDTO user, model.ClientServerDTO client)
      {
        #if SILVERLIGHT
      ...
      #if SILVERLIGHT
      public IAsyncResult send_logout(AsyncCallback callback, object state, model.UserDTO user, model.ClientServerDTO client)
      {
      ...
      public void send_logout(model.UserDTO user, model.ClientServerDTO client)
      {
        oprot_.WriteMessageBegin(new TMessage("logout", TMessageType.Call, seqid_));
        logout_args args = new logout_args();
        args.User = user;
      ...
      public List<model.ProbaDTO> End_getProbeAndNrParticipanti(IAsyncResult asyncResult)
      {
        oprot_.Transport.EndFlush(asyncResult);
      ...
      public List<model.ProbaDTO> getProbeAndNrParticipanti()
      {
        #if SILVERLIGHT
      ...
      public List<model.ProbaDTO> recv_getProbeAndNrParticipanti()
      {
        TMessage msg = iprot_.ReadMessageBegin();
        if (msg.Type == TMessageType.Exception) {
          TApplicationException x = TApplicationException.Read(iprot_);
      ...
      public List<model.ParticipantDTO> End_getParticipantiByProba(IAsyncResult asyncResult)
      {
        oprot_.Transport.EndFlush(asyncResult);
      ...
      public List<model.ParticipantDTO> getParticipantiByProba(int idProba)
      {
        #if SILVERLIGHT
      ...
      public List<model.ParticipantDTO> recv_getParticipantiByProba()
      {
        TMessage msg = iprot_.ReadMessageBegin();
        if (msg.Type == TMessageType.Exception) {
          TApplicationException x = TApplicationException.Read(iprot_);
      ...
      public IAsyncResult Begin_inscriereParticipant(AsyncCallback callback, object state, model.ParticipantDTO participant, string tipProba1, string tipProba2)
      {
      ...
      public void inscriereParticipant(model.ParticipantDTO participant, string tipProba1, string tipProba2)
      {
        #if SILVERLIGHT
      ...
      #if SILVERLIGHT
      public IAsyncResult send_inscriereParticipant(AsyncCallback callback, object state, model.ParticipantDTO participant, string tipProba1, string tipProba2)
      {
      ...
      public void send_inscriereParticipant(model.ParticipantDTO participant, string tipProba1, string tipProba2)
      {
        oprot_.WriteMessageBegin(new TMessage("inscriereParticipant", TMessageType.Call, seqid_));
        inscriereParticipant_args args = new inscriereParticipant_args();
        args.Participant = participant;
    ...
    {
      private model.UserDTO _user;
      private model.ClientServerDTO _client;

      public model.UserDTO User
      {
        get
        {
          return _user;
      ...
      public model.ClientServerDTO Client
      {
        get
        {
          return _client;
        ...
        try
        {
          ...
          while (true)
          {
            ...
            switch (field.ID)
            {
              ...
              case 2:
                if (field.Type == TType.Struct) {
                  Client = new model.ClientServerDTO();
                  Client.Read(iprot);
                } else { 
                  TProtocolUtil.Skip(iprot, field.Type);
                }
    ...
    {
      private List<model.ProbaDTO> _success;
      private ConcursException _ex;

      public List<model.ProbaDTO> Success
      {
        get
        {
          return _success;
            ...
            switch (field.ID)
            {
              case 0:
                if (field.Type == TType.List) {
                  {
                    Success = new List<model.ProbaDTO>();
                    TList _list0 = iprot.ReadListBegin();
                    for( int _i1 = 0; _i1 < _list0.Count; ++_i1)
                    {
                      model.ProbaDTO _elem2;
                      _elem2 = new model.ProbaDTO();
                      _elem2.Read(iprot);
                      Success.Add(_elem2);
                    }
                    iprot.ReadListEnd();
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (model.ProbaDTO _iter3 in Success)
                {
                  _iter3.Write(oprot);
                }
                oprot.WriteListEnd();
    ...
    {
      private List<model.ParticipantDTO> _success;
      private ConcursException _ex;

      public List<model.ParticipantDTO> Success
      {
        get
        {
          return _success;
          ...
          while (true)
          {
            ...
            switch (field.ID)
            {
              case 0:
                if (field.Type == TType.List) {
                  {
                    Success = new List<model.ParticipantDTO>();
                    TList _list4 = iprot.ReadListBegin();
                    for( int _i5 = 0; _i5 < _list4.Count; ++_i5)
                    {
                      model.ParticipantDTO _elem6;
                      _elem6 = new model.ParticipantDTO();
                      _elem6.Read(iprot);
                      Success.Add(_elem6);
                    }
                    iprot.ReadListEnd();
        ...
        try
        {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (model.ParticipantDTO _iter7 in Success)
                {
                  _iter7.Write(oprot);
                }
                oprot.WriteListEnd();
    ...
    {
      private model.ParticipantDTO _participant;
      private string _tipProba1;
      private string _tipProba2;

      public model.ParticipantDTO Participant
      {
        get
        {
          return _participant;
        ...
        try
        {
          ...
          while (true)
          {
            ...
            switch (field.ID)
            {
              case 1:
                if (field.Type == TType.Struct) {
                  Participant = new model.ParticipantDTO();
